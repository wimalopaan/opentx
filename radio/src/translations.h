...
#define OFS_USBENABLEMODES      (OFS_COUNTRYCODES + sizeof(TR_COUNTRYCODES))
#define OFS_USBMODES            (OFS_USBENABLEMODES + sizeof(TR_USBENABLEMODES))
...
#define STR_VTMRMODES           (STR_OPEN9X + OFS_VTMRMODES)
  ...
  #define STR_USBENABLEMODES    (STR_OPEN9X + OFS_USBENABLEMODES)
...
extern const char STR_USBENABLE[];
