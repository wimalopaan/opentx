...
static void parseParameterInfoMessage(uint8_t* data, uint8_t length) {
  ...
  //  #define ELRS_TYPE_TEST
  #if defined(ELRS_TYPE_TEST)
    if (data[3] == 5) {
      uint8_t floatParameter[] = {
        TYPE_FLOAT ,0x46 ,0x4C ,0x4F ,0x41 ,0x54 ,0x00 ,
        0x00 ,0xBC ,0x61 ,0x4E , /* value */
        0x00 ,0xBC ,0x4B ,0x20 , /* min */
        0x00, 0xBC ,0x72 ,0x30 , /* max */
        0x04 , /* prec */
        0x00 ,0x00 ,0x00 ,0x0F , /* step */
        0x55 ,0x6E ,0x69 ,0x74, 0x00};
      uint8_t uint8Parameter[] = {
        TYPE_UINT8 ,0x55 ,0x49 ,0x4E ,0x54 ,0x38 ,0x00 ,
        0xEF , /* value */
        0xD0 , /* min */
        0xFF , /* max */
        0xE0 , /* default */
        0x55 ,0x6E ,0x69 ,0x74, 0x00};
      uint8_t int8Parameter[] = {
        TYPE_INT8 ,0x49 ,0x4E ,0x54 ,0x38 ,0x00 ,
        0x7F , /* value */
        0x6F , /* min */
        0x8F , /* max */
        0x88 , /* default */
        0x55 ,0x6E ,0x69 ,0x74, 0x00};
      uint8_t int16Parameter[] = {
        TYPE_INT16 ,0x49 ,0x4E ,0x54 ,0x31 ,0x36 ,0x00 ,
        0x80, 0x02 , /* value */
        0x00, 0x6F , /* min */
        0x00, 0x8F , /* max */
        0x00, 0x88 , /* default */
        0x55 ,0x6E ,0x69 ,0x74, 0x00};
      uint8_t uint16Parameter[] = {
        TYPE_UINT16 ,0x55 ,0x49 ,0x4E ,0x54 ,0x31 ,0x36 ,0x00 ,
        0x80, 0x02 , /* value */
        0x00, 0x6F , /* min */
        0x00, 0x8F , /* max */
        0x00, 0x88 , /* default */
        0x55 ,0x6E ,0x69 ,0x74, 0x00};
      uint8_t stringParameter[] = {
        TYPE_STRING ,0x4E ,0x61 ,0x6D ,0x65 ,0x00,
        0x62, 0x6C, 0x61, 0x00, /* string */
        0x55 ,0x6E ,0x69 ,0x74, 0x00};
      memcpy(&data[6], &stringParameter, sizeof(stringParameter));
    }
  #endif
